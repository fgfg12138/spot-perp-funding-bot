...
export const DEFAULT_USER_STRATEGY_SETTINGS: UserStrategySettings = {
  ...
  universe: { useDynamicUniverse: true, maxDynamicSymbolsPerExchange: 1000, minSpotVolume24hUsdt: 1_000_000, minPerpVolume24hUsdt: 5_000_000, allowSmallCaps: false, symbolWhitelist: [], symbolBlacklist: [], prioritySymbols: ["BTC/USDT","ETH/USDT","SOL/USDT","XRP/USDT","DOGE/USDT","BNB/USDT","ADA/USDT","AVAX/USDT","LINK/USDT","SUI/USDT"] },
...
export function validateSettings(s: UserStrategySettings): string[] {
  ...
  if (s.universe.maxDynamicSymbolsPerExchange < 1 || s.universe.maxDynamicSymbolsPerExchange > 2000) errors.push("maxDynamicSymbolsPerExchange 必须在 1-2000 之间");
